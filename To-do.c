...
int main(){
  ...
  while (running){  
    ...
    switch(choice){
      ...
      break;
        case 3:
      printf("Wpisz indeks zadania: ");
      scanf("%d", &indexInput);
      markCompleted(indesInput);
      ...
      printf("Wpisz indeks zadania: ");
      scanf("%d", &indexInput);
      printf("Wpisz zadanie do edycji");
      getrchar();
      fgets(taskInput, sizeof(taskInout), stdin); 
      taskInput[strcspn(taskInput, "\n")] = '\0';
      ...
      break;
        ...
        case 6:
          running = 0; // running = 0 zakończenie programu //
          break;
